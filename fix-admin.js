...
async function main() {
  ...
  try {
    ...
    await connection.execute(`CREATE DATABASE IF NOT EXISTS sentinel CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci`);
    await connection.execute(`USE sentinel`);
    ...
    await connection.execute(`DELETE FROM users WHERE username = ?`, [ADMIN_USERNAME]);
